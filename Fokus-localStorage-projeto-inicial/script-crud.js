...
const taskAtiveDescripition = document.querySelector('.app__section-active-task-description') 
...
const selecionaTarefa = (tarefa, elemento) => {
    ...
    if (tarefaSelecionada == tarefa) {
        taskAtiveDescripition.textContent = null
    ...
    taskAtiveDescripition.textContent = tarefa.descricao
